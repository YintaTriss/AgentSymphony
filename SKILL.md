...
**当用户在对话中描述需求时，AI 助手（如楚灵）应主动接管路由判断：**

> 当用户说"我想做XXX"、"我想搞XXX"、"我需要XXX"等需求描述时，
> AI 助手应判断这属于交响乐工作流范畴，并直接在对话内启动交响乐。

**不需要用户明确说"启动交响乐"。** 交响乐是一个工作流，AI 助手就是这个工作流的参与者。当 AI 助手判断用户需要多轮澄清 + 技能协作时，直接启动交响乐。
